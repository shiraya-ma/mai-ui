...
export const FormattingContentWithinTables = Template.bind({});
FormattingContentWithinTables.args = {
  children: _getSampleMarkdownContents().FORMATTING_CONTENT_WITHIN_TABLE,
  ogpFetcher: ogpFetcher,
};
...
<!-- - ![hoge](https://myoctocat.com/assets/images/base-octocat.svg)
    - ![hoge](https://myoctocat.com/assets/images/base-octocat.svg) -->
`;
...
`;
  ...
  const FORMATTING_CONTENT_WITHIN_TABLE = `
| Command | Description |
| --- | --- |
| \`git status\` | List all *new or modified* files |
| \`git diff\` | Show file differences that **haven't been** staged |
...
`;
  ...
  return {
    ...
    TABLES,
    FORMATTING_CONTENT_WITHIN_TABLE,
    SECTIONS,
  };
};
